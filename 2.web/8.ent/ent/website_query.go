...
func (wq *WebsiteQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (wq *WebsiteQuery) FirstIDX(ctx context.Context) int32 {
...
func (wq *WebsiteQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (wq *WebsiteQuery) OnlyIDX(ctx context.Context) int32 {
...
func (wq *WebsiteQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (wq *WebsiteQuery) IDsX(ctx context.Context) []int32 {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wq *WebsiteQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(website.Table, website.Columns, sqlgraph.NewFieldSpec(website.FieldID, field.TypeInt32))
	_spec.From = wq.sql
