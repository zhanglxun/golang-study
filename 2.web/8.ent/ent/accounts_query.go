...
func (aq *AccountsQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (aq *AccountsQuery) FirstIDX(ctx context.Context) int32 {
...
func (aq *AccountsQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (aq *AccountsQuery) OnlyIDX(ctx context.Context) int32 {
...
func (aq *AccountsQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (aq *AccountsQuery) IDsX(ctx context.Context) []int32 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AccountsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(accounts.Table, accounts.Columns, sqlgraph.NewFieldSpec(accounts.FieldID, field.TypeInt32))
	_spec.From = aq.sql
