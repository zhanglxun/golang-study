...
func (ad *AccountsDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, AccountsMutation](ctx, ad.sqlExec, ad.mutation, ad.hooks)
}
...
func (ad *AccountsDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(accounts.Table, sqlgraph.NewFieldSpec(accounts.FieldID, field.TypeInt32))
